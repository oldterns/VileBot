...
public class InspirationService
{
    ...
    {
        try (InputStream inspirationIndexResource = InspirationService.class.getResourceAsStream("/inspirationslist.txt")) {
            if (inspirationIndexResource == null) {
                throw new IOException("Unable to find inspirationslist.txt");
            }
            return new BufferedReader(new InputStreamReader(inspirationIndexResource))
                    .lines()
    ...
    {
        try (InputStream inspirationIndexResource = InspirationService.class.getResourceAsStream("/inspirationsindex.txt")) {
            if (inspirationIndexResource == null) {
