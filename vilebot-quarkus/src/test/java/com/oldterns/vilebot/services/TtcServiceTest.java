...
public class TtcServiceTest {
    ...
    @Test
    public void testPrintAlerts() throws MalformedURLException {
        TtcService ttcService = new TtcService();
        urlStreamHandler.mockConnection(new URL(TtcService.TTC_URL),
                TtcServiceTest.class.getResourceAsStream("ttc-example-alerts.html"));
        assertThat(ttcService.printAlerts()).isEqualTo(
                "Line 1: There is no subway service between Sheppard-Yonge and Bloor-Yonge stations due to ATC signal system testing. Shuttle buses are running.\n"
