...
public class WeatherServiceTest
{
        ...
        throws MalformedURLException
    {
        ...
        urlStreamHandler.mockConnection( new URL( YYZ ),
                                         WeatherServiceTest.class.getResourceAsStream( "ytz-weather-data.xml" ) );
        assertThat( weatherService.onWeather(channelMessageEvent, Optional.empty()) ).isEqualTo( "Sunny, Temperature: 14.5°C, Humidity: 46 % - Toronto City Centre Airport 7:00 PM EDT Sunday 30 May 2021" );
    }
        ...
        throws MalformedURLException
    {
        ...
        urlStreamHandler.mockConnection( new URL( YGK ),
                                         WeatherServiceTest.class.getResourceAsStream( "ygk-weather-data.xml" ) );
        assertThat( weatherService.onWeather( channelMessageEvent,Optional.of("ygk") ) ).isEqualTo( "Partly Cloudy, Temperature: 16.7°C, Humidity: 46 % - Kingston Airport 7:00 PM EDT Sunday 30 May 2021" );
    }
        ...
        throws MalformedURLException
    {
        ...
        ChannelMessageEvent channelMessageEvent = new ChannelMessageEvent(client, serverMessage, user, channel, "!lessweather");
        ...
        throws MalformedURLException
    {
        ...
        urlStreamHandler.mockConnection( new URL( YYZ ),
                                         WeatherServiceTest.class.getResourceAsStream( "ytz-weather-data.xml" ) );
        assertThat( weatherService.onMoreWeather(channelMessageEvent, Optional.empty()) ).isEqualTo( "[Observed at: Toronto City Centre Airport 7:00 PM EDT Sunday 30 May 2021] [Condition: Sunny] [Temperature: 14.5°C] [Pressure: 102.3 kPa] [Visibility: 16.1 km] [Humidity: 46 %] [Dewpoint: 3.1°C] [Wind: SSW 4 km/h] [Air Quality Health Index: N/A] " );
    }
        ...
        throws MalformedURLException
    {
        ...
        urlStreamHandler.mockConnection( new URL( YGK ),
                                         WeatherServiceTest.class.getResourceAsStream( "ygk-weather-data.xml" ) );
        assertThat( weatherService.onMoreWeather( channelMessageEvent, Optional.of("ygk") ) ).isEqualTo( "[Observed at: Kingston Airport 7:00 PM EDT Sunday 30 May 2021] [Condition: Partly Cloudy] [Temperature: 16.7°C] [Pressure / Tendency: 102.3 kPa falling] [Visibility: 24.1 km] [Humidity: 46 %] [Dewpoint: 5.1°C] [Wind: SSE 13 km/h] [Air Quality Health Index: 2] " );
    }
}
